                                            ...
                                            <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    if (isset($_POST['filter'])) {
                                                        ...
                                                        $series = $_POST['series'];
                                                        $sql = "SELECT id, Department, Series, Section, Semester, CreationDate FROM tblclasses WHERE 1=1";
                                                        if ($department != "") {
                                                        ...
                                                        $sql .= " ORDER BY Semester"; // Sort by Semester
                                                        $query = $dbh->prepare($sql);
                                                        if ($department != "") {
                                                    ...
                                                    if (count($results) > 0) {
                                                        foreach ($results as $result) { ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="edit-class.php?classid=<?php echo htmlentities($result->id); ?>" class="btn btn-primary btn-xs" target="_blank">Edit</a>
                                                                    <a href="delete-class.php?classid=<?php echo htmlentities($result->id); ?>" class="btn btn-danger btn-xs" target="_blank" onclick="return confirm('Are you sure you want to delete this class?');">Delete</a>
                                                                </td>
                                                            </tr>
                                                        <?php $cnt++;
                                                        }
