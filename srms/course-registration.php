                                ...
                                <div class="col-md-12">
                                    <div class="panel">
                                        ...
                                        <?php if ($msg) { ?>
                                                    ...
                                                    if (count($results) > 0) {
                                                        foreach ($results as $result) { ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo htmlentities($result->CourseCredit*20); ?></td>
                                                                <td>
                                                                        <input type="checkbox" name="selected_courses[]" value="<?php echo htmlentities($result->CourseCode); ?>">
                                                                </td>
                                                                <td>
                                                                    <a href="edit-student.php?stid=<?php echo htmlentities($result->id); ?>" class="btn btn-primary btn-xs" target="_blank">Edit</a>
                                                                    <a href="edit-result.php?stid=<?php echo htmlentities($result->id); ?>" class="btn btn-warning btn-xs" target="_blank">View Result</a>
                                                                </td>
                                                            </tr>
                                                        <?php $cnt++;
                                                        }
                                            ...
                                            <input type="hidden" name="semester" value="<?php echo htmlentities($semester); ?>">
