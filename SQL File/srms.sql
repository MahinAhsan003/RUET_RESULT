...
CREATE TABLE `tblregistration` (
  ...
  `RegistrationStatus` INT DEFAULT 0,
  `RegistrationTime` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`RollId`, `Semester`, `RegisteredCourse`),
  FOREIGN KEY (`RollId`) REFERENCES `tblstudents`(`RollId`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
-- (2010003, 1, 'ECE-1101,ECE-1102,ECE-1103,ECE-1104,MATH-1117,PHY-1117,PHY-1118,HUM-117,HUM-1118,ECE-1100', 1),
-- (2010004, 1, 'ECE-1101,ECE-1102,ECE-1103,ECE-1104,MATH-1117,PHY-1117,PHY-1118,HUM-117,HUM-1118,ECE-1100', 1),
-- (2010005, 1, 'ECE-1101,ECE-1102,ECE-1103,ECE-1104,MATH-1117,PHY-1117,PHY-1118,HUM-117,HUM-1118,ECE-1100', 1),
-- (2010006, 1, 'ECE-1101,ECE-1102,ECE-1103,ECE-1104,MATH-1117,PHY-1117,PHY-1118,HUM-117,HUM-1118,ECE-1100', 1),
-- (2010007, 1, 'ECE-1101,ECE-1102,ECE-1103,ECE-1104,MATH-1117,PHY-1117,PHY-1118,HUM-117,HUM-1118,ECE-1100', 1),
-- (2010008, 1, 'ECE-1101,ECE-1102,ECE-1103,ECE-1104,MATH-1117,PHY-1117,PHY-1118,HUM-117,HUM-1118,ECE-1100', 1),
